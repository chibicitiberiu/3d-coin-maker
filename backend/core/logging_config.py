...
def get_log_files(log_dir: Optional[Path] = None, app_name: str = "coin_maker") -> dict[str, Path]:
    """
...
def setup_desktop_logging(debug: bool = False) -> None:
    """
    ...
    setup_logging(log_level=log_level, app_name="coin_maker_desktop")
